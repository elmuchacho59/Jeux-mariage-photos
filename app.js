const i18n = {
  ...
  es: {
    ...
    cameraApiUnavailable: "La API de la caméra n'est pas disponible en este navegador.",
    cameraError: "No se puede abrir la caméra. ¿Has dado permiso?",
    ...
    cameraErrorPrompt: "Error de caméra:",
